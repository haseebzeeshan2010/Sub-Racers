...
func play_intro():
	change_music("res://Assets/Audio/Music/SubRacersIntroStreamv2.tres")

# When the intro track finishes, switch to the loop
func _on_intro_music_finished():
	change_music("res://Assets/Audio/Music/SubRacersIntroLoopStreamv2.tres")

# Level music (called when gameplay starts)
func levelmusic():
	change_music_smooth("res://Assets/Audio/Music/SubRacersRaceThemeLoopStream.tres")

func selection_music():
	change_music_smooth("res://Assets/Audio/Music/SubRacersIntroLoopStreamv2.tres")
